...
export class CalibrationDocument extends Input {

    static TEST_PART_1: CalibrationDocument = new CalibrationDocument(
        '1abc2\n' +
        'pqr3stu8vwx\n' +
        'a1b2c3d4e5f\n' +
        'treb7uchet',
    ...
    static TEST_PART_2: CalibrationDocument = new CalibrationDocument(
        'two1nine\n' +
        'eightwothree\n' +
        'abcone2threexyz\n' +
        'xtwone3four\n' +
